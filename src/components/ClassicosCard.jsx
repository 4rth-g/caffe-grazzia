const ClassicosCard = ({ nome, descricao, imagem }) => {
  return(
  <div className="bg-brand-dark rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:bg-brand-light hover:scale-105 hover:shadow-xl cursor-pointer">
